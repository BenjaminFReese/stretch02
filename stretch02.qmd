...
The other types of leaving including in the dataset like retirements and Reductions In Force are mostly controllable or easily predicted by agencies based on the age of their employees and their internal staffing decisions. Quitting, though, can seriously disrupt an agencies function and is not as easily controlled by federal managers. Hopefully, this model will give some indication about when employees are likely to quit, and show the important factors that predict quitting.
